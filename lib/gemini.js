 ...
 */
async function matchChunk(query, chunk, model) {
  const index = chunk.map(buildIndexLine).join("\n");
...
اختر الأنسب أو أرجع matched: false إذا لا يوجد أي صلة بالضرائب العقارية.`;
